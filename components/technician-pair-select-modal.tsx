...
interface TechnicianPairSelectModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSelect: (t1: Technician, t2: Technician) => void;
  currentT1?: any;
  currentT2?: any;
}

export function TechnicianPairSelectModal({
  open,
  onOpenChange,
  onSelect,
  currentT1,
  currentT2
}: TechnicianPairSelectModalProps) {
  ...
  }, [open, currentT1, currentT2, technicians]);
  ...
  const handleConfirm = () => {
    if (selectedT1 && selectedT2) {
      onSelect(selectedT1, selectedT2);
      onOpenChange(false);
    }
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-3xl max-h-[88vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose Technician 1 (T1) and Technician 2 (T2) for this service
          </DialogDescription>
        </DialogHeader>
          ...
          {loading ? (
            ...
            <div className="divide-y">
              {filteredTechnicians.map((tech) => {
                ...
                const isSelected = isSelectedT1 || isSelectedT2;
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={!selectedT1 || !selectedT2}
